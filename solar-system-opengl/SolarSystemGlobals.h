...
const GLfloat LIGHT_AMBIENT[]       = { 0.8, 0.8, 0.8, 0.0};
const GLfloat LIGHT_DIFFUSE[]       = { 0.9, 0.9, 0.9, 0.0};
const GLfloat LIGHT_SPECULAR[]      = { 1.0, 1.0, 1.0, 0.0};
const GLfloat LIGHT_MODEL_AMBIENT[] = { 0.2, 0.2, 0.2, 0.0};
...
const GLfloat SATURN_RADIUS = 	1.5;
